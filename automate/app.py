    ...
    with tabs[2]:
        ...
        if violations_df.empty:
            ...
            if filter_btn_v:
                ...
                if save_selection:
                    ...
                    if st.button("Proceed to Update", key="proceed_update"):
                        ...
                        if upd_mode == "Automatic":
                            ...
                            if st.button("Update Data (Automatic)", key="upd_btn_auto"):
                            ...
                            if st.button("Update Data (Manual)", key="upd_btn_manual"):
                                sheets_dict = pd.read_excel(FILE_PATH, sheet_name=None)
                                for sheet_name, df in sheets_dict.items():
                                    if sheet_name == "Home":
                                        continue
                ...
                st.info("Apply filters above to view violations for update.")
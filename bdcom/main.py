"""
dash_ag_grid_code.py  –  value-list filters with Dash AG Grid
...
grid_opts = {                 # re-used for every grid
    "pagination": True,
...
def master_cb(click_event, n_vd, n_pc,
    ...
    if trig == "summary" and click_event:
        field_active = click_event["data"]["Field Name"]
    else:

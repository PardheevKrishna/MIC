...
def process_file(path):
    ...
    # 1) Read only needed columns with pandas.read_excel
    ...
    # 2) Fill missing variances if needed
    ...
    for j, mn in enumerate(var_names):
        ...
        # Assign quartiles array-wise with .loc
    ...
    # 4) Fast vectorized write of variances.xlsx (no options arg)
    ...
    # 5) Build single‐page PDF summary + hyperlink
